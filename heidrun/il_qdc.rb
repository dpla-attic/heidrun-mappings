Krikri::Mapper.define(:il_qdc,
  ...
  sourceResource class: DPLA::MAP::SourceResource do
    ...
    collection class: DPLA::MAP::Collection,
               each: record.field('xmlns:setSpec'),
               as: :coll do
      title coll
    end
    ...
    date class: DPLA::MAP::TimeSpan,
         each: record.field('dc:date', 'dcterms:created'),
         as: :created do
    ...
    spatial class: DPLA::MAP::Place,
            each: record.field('dcterms:spatial'),
            as: :place do
      providedLabel place
    end
    ...
    temporal class: DPLA::MAP::TimeSpan,
             each: records.field('dcterms:temporal'),
             as: :temp do
      providedLabel temp
    end
